...
export async function run() {
	...
	const extension = vscode.extensions.getExtension<RooCodeAPI>("kilocode.SpeXcode-Code")
	...
	/**
	 * Wait for SpeXcode to be ready to accept tasks.
	 */

	await waitUntilReady({ api })

	/**
	 * Configure SpeXcode as needed.
	 *
