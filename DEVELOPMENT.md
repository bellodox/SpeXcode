# SpeXcode Development Guide

> **Note**: New versions of the VS Code extension and CLI are being developed in [SpeXcode-Org/SpeXcode](https://github.com/SpeXcode-Org/SpeXcode) (extension at `packages/kilo-vscode`, CLI at `packages/opencode`). If you're looking to develop or contribute to the extension or CLI, please refer to the development guide in that repository instead.

Welcome to the SpeXcode development guide! This document will help you set up your development environment and understand how to work with the codebase. Whether you're fixing bugs, adding features, or just exploring the code, this guide will get you started.

## Prerequisites

Use the native VS Code extension development setup documented here:

### Native Development

1. **Git** - For version control
2. **Git LFS** - For large file storage (https://git-lfs.com/) - Required for handling GIF, MP4, and other binary assets
3. **Node.js** (version [v20.20.0](https://github.com/bellodox/SpeXcode/blob/main/.nvmrc) recommended)
...
1. **Fork and Clone the Repository**:
    ...
    - **Fork the Repository**:
        - Visit the [SpeXcode GitHub repository](https://github.com/bellodox/SpeXcode)
        - Click the "Fork" button in the top-right corner to create your own copy.
    - **Clone Your Fork**:
        ```bash
        git clone https://github.com/[YOUR-USERNAME]/kilocode-legacy.git
        cd kilocode-legacy
        ```
...
The full list of recommended extensions is [here](https://github.com/bellodox/SpeXcode/blob/main/.vscode/extensions.json)
...
For details on where SpeXcode stores configuration, data, and cache files at runtime, see [File Locations](docs/file-locations.md).
...
2. This will open a new VSCode window with SpeXcode loaded
...
SpeXcode uses several types of tests to ensure quality:
...
- Check the Output panel in VSCode (View > Output) and select "SpeXcode" from the dropdown
- For webview issues, use the browser developer tools in the webview (right-click > "Inspect Element")

### Testing with Local Backend

To test the extension against a local SpeXcode backend:
...
We welcome contributions to SpeXcode! Here's how you can help:

1. **Report an issue** using [GitHub Issues](https://github.com/bellodox/SpeXcode/issues)
2. **Find an issue** and submit a Pull Request with your fix
3. **Write tests** to improve Code Coverage
4. **Improve Documentation** at [kilo.ai/docs](https://github.com/bellodox/SpeXcode/tree/main/docs)
5. **Suggest a new feature** using [GitHub Discussions](https://github.com/bellodox/SpeXcode/discussions/categories/ideas)!
6. Want to **implement something new**? Awesome! We'd be glad to support you on [Discord](https://github.com/bellodox/SpeXcode/discussions)!

## Community

Your contributions are welcome! For questions or ideas, please join our Discord server: https://github.com/bellodox/SpeXcode/discussions
