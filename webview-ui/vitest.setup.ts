...
globalThis.process.env.NODE_ENV = "test" // kilocode_change force test mode instead for: https://github.com/bellodox/SpeXcode/blob/main/webview-ui/src/components/settings/SettingsView.tsx
